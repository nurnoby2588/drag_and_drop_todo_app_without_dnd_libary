...
//               className="px-6 bg-linear-to-r from-yellow-500 to-orange-500 text-white font-medium hover:from-pink-500 hover:to-yellow-500 transition-all duration-300 transform hover:scale-105"
//             >
//               Add
//             </button>
//           </div>
...
//                     </div>
//                   ) : (
//                     columns[columnsName].items.map((item) => (
//                       <div
//                         key={item.id}
